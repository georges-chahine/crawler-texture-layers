...
protected:
    ...
    Eigen::Matrix4d getPoseTf(){
        ...
        pcl::octree::OctreePointCloudSearch<pcl::PointXYZ> voxelize(pcl::PointCloud<pcl::PointXYZ>::Ptr& temp_cloud, float leaf_size=resolution_){
...
//            delta_cum=0;
        ...
        void scan_callback(const sensor_msgs::PointCloud2ConstPtr& msg){
            ...
            pcl::PointCloud<pcl::PointXYZRGB>::Ptr scan_pcl (new pcl::PointCloud<pcl::PointXYZRGB>);
            pcl::fromROSMsg( *msg, *scan_pcl);
...
public:
    ...
    Mapper() : n("~"), it(n) {
        ...
        scan_sub_ = n.subscribe("scans",1,&FloorPlaneRansac::scan_callback,this);
